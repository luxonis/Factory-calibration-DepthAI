...
class StereoCalibration(object):
    ...
    def calibrate_intrinsics(self, image_files, camera_model):
        image_files.sort()
        assert len(image_files) != 0, "ERROR: Images not read correctly, check directory"
    ...
    def calibrate_extrinsics(self, images_left, images_right, M_l, d_l, M_r, d_r, guess_translation, guess_rotation):
        ...
        ret, M1, d1, M2, d2, R, T, E, F = self.calibrate_stereo(allCorners_l, allIds_l, allCorners_r, allIds_r, self.img_shape, M_lp, d_l, M_rp, d_r)
